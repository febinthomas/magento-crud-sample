 ...
 * @author      Febin Thomas
 */
class Febin_Employee_Block_Adminhtml_Blog_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Febin_Employee_Block_Adminhtml_Blog_Edit_Tab_Stores
     * @author Febin Thomas
     */
