 ...
 * @author      Febin Thomas
 */
class Febin_Employee_Model_Resource_Blog extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('febin_employee/blog', 'entity_id');
    }
    ...
    public function lookupStoreIds($blogId)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('febin_employee/blog_store'), 'store_id')
     ...
     * @return Febin_Employee_Model_Resource_Blog
     * @author Febin Thomas
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Febin_Employee_Model_Blog $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('employee_blog_store' => $this->getTable('febin_employee/blog_store')),
                $this->getMainTable() . '.entity_id = employee_blog_store.blog_id',
                array()
            )
            ->where('employee_blog_store.store_id IN (?)', $storeIds)
            ->order('employee_blog_store.store_id DESC')
            ->limit(1);
        }
        return $select;
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('febin_employee/blog_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store)
    {
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('febin_employee/blog_store')),
