 ...
 * @author      Febin Thomas
 */
class Febin_Employee_Model_Resource_Blog_Comment_Blog_Collection extends Febin_Employee_Model_Resource_Blog_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('febin_employee/blog_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('febin_employee/blog_comment');
        $this->getSelect()->join(
