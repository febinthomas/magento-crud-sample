 ...
 * @author      Febin Thomas
 */
abstract class Febin_Employee_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Febin_Employee_Helper_Image_Abstract
     * @author Febin Thomas
     */
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Febin_Employee_Helper_Image_Abstract)
     * @author Febin Thomas
     */
